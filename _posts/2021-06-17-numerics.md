...
If you are familiar with those methods or are only intersted in the reason why you should carefully examine your problem to choose a suitable method, you can skip over to the [last section](#why-isn't-there-the-one-thing-to-rule-them-all?)
...
We will briefly explore the most prevalent methods that at the same time covers the widely available commercial codes. To give a little structure to this list, I will present them in loose historical order.
